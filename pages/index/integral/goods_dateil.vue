	...
	<view>
		...
		<view class="content">
			...
			<view class="pd-desc-info">
				<view class="pd-desc-price">
						<label style="color: #8c8c8c;"></label><label style="margin-left: 10upx;color: #ed2c44;font-weight:550">2000积分</label>
				</view>
		...
		<view class="content_back">
			<view class="title">
				...
				<label style="margin: 0 10upx;">产品详情介绍</label>
				<image src="../../../static/icon_green.png"></image>
			</view>
		</view>
...
<style lang='scss'>
	...
	.popup {
		...
		.but{
			width: 700upx;margin: 0 auto; border-radius: 30upx;background-color: #1e936b;text-align: center;color: #FFFFFF;margin-bottom: 50upx;padding: 20upx 0;
			margin-left: 20upx;
		}
		@keyframes showPopup {
			0% {
